public class AND extends CONDICION{
    ...
    public void ctd(){
        ...
        String etiqIzq1 = ((CONDICION)izq).getEtiquetas().v();
        String etiqIzq2 = ((CONDICION)izq).getEtiquetas().f();

        //En el caso de que se cumpla la 1ª cond, se evaluará la siguiente condición
        Generador.printLabel(etiqIzq1);

        //Se evalúa la 2ª cond
        der.ctd();
        
        //Se obtienen los Li y Lj de la 2ª condición
        String etiqDer1 = ((CONDICION)der).getEtiquetas().v();
        String etiqDer2 = ((CONDICION)der).getEtiquetas().f();
        ...
        Generador.printLabel(etiqIzq2);
        Generador.printGoToLabel(etiqDer2);
        ...
        this.trueOrFalse = new ETIQCASOS(etiqDer1, etiqDer2); 
