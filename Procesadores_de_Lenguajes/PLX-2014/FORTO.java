public class FORTO extends AST {
    ...
    public FORTO(String i, AST asignacion, AST valorfinal, AST actualizacion, AST sentencia) {
    ...
    public void ctd(){
        ...
        Generador.condicion(Generador.MENOR, valorFinal.getCodigo(), id, trueorFalse);
