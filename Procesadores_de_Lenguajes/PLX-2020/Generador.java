public class Generador {
    ...
    */
    ...
    public static void funcion(String nomFuncion){
        System.out.println("function " + nomFuncion + ":");
    } 

    public static void end(String nomFuncion){
        System.out.println("end " + nomFuncion + ";");
    }

    public static void call(String nomFuncion){
        System.out.println("\tcall " + nomFuncion + ";");
    }
    ...
    /*
            ...
            Si length de un array es tam y quremos acceder a la pos indice, imprime
            if (indice < 0) goto L0;
    ...
    public static void condVector(String indice, int tam, String v, String w){
        System.out.println("\tif ("+indice+" < "+0+") goto "+v+";");
        System.out.println("\tif ("+tam+" < "+indice+") goto "+v+";");
        System.out.println("\tif ("+tam+" == "+indice+") goto "+v+";");
        printGoToLabel(w);
    }
