...
máximoDeTres' :: Int -> Int -> Int -> Int
máximoDeTres' x y z | x > máximo y z = x
                    | otherwise = máximo y z
...
sonIguales :: Eq(a) => (a,a) -> Bool -- Función sobrecargada
sonIguales (x,y) = (x==y)
...
inverso x |x == 0 = error "inverso: división por cero"
          |otherwise = (1/x)
